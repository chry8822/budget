  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        settingsIconWrap: { padding: theme.spacing.xs },
        budgetButton: {
          borderWidth: 1,
        ...
        compareHeaderText: { fontWeight: 'bold' },
        diffText: {
          marginTop: theme.spacing.xs,
          fontSize: theme.typography.sizes.xs,
          color: theme.colors.textMuted,
        },
        incomeText: { color: theme.colors.income ?? '#2e7d32' },
        expenseText: { color: theme.colors.primary },
        warnText: { color: theme.colors.primary, fontWeight: 'bold' },
        tabRow: {
          flexDirection: 'row',
          marginBottom: theme.spacing.md,
          borderRadius: 999,
        ...
        remainingBudgetBlockCompact: { marginBottom: theme.spacing.sm },
        ...
        progressWrap: { marginVertical: theme.spacing.xs },
        progressTrack: {
          height: 8,
          borderRadius: 4,
        ...
        >
          ...
          <View style={styles.headerRow}>
            <View style={styles.monthNav}>
              ...
              >
                <Ionicons name="chevron-back" size={20} color={appTheme.colors.text} />
              </TouchableOpacity>
              ...
              >
                <Text style={[styles.monthLabel, { color: appTheme.colors.text }]}>
                  {monthLabel}
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}
              >
                <Ionicons name="chevron-forward" size={20} color={appTheme.colors.text} />
              </TouchableOpacity>
            </View>
            <Pressable
            ...
            >
              <Ionicons name="settings-outline" size={22} color={appTheme.colors.text} />
            </Pressable>
          </View>
          ...
          {summaryTab === 'summary' ? (
            <>
              ...
              <View style={styles.card}>
                ...
                <View style={styles.row}>
                  ...
                  <Text style={[styles.rowValue, styles.incomeText]}>
            ...
            (() => {
              ...
              const totalPercent =
                totalBudget > 0
                  ? Math.round((totalSpentInBudgetCategories / totalBudget) * 100)
                  : 0;
                  ...
                  {budgetRows.length === 0 ? (
                    ...
                    <>
                      {totalBudget > 0 ? (
                        ...
                        <View
                          style={[styles.remainingBudgetBlock, styles.remainingBudgetBlockCompact]}
                        >
                          <Pressable
                            onPress={() => navigation.navigate('BudgetSetting', { year, month })}
                            style={styles.budgetButton}
                      ...
                      {totalBudget > 0 ? (
                        <View style={styles.monthlyBudgetBlock}>
                          ...
                          <View style={styles.budgetMeta}>
                            <Text style={[styles.budgetMetaText, styles.budgetMetaTextPrimary]}>
